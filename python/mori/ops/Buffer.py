...
class Buffer:
    ...
    def dispatch(self, x: Union[torch.Tensor, Tuple[torch.Tensor, torch.Tensor]],
        ...
        print(f"[inp shape {inp.shape if not isinstance(x, tuple)  else inp[0].shape}] , topk_weights shape {topk_weights.shape}, inp_scales shape={inp_scales.shape}, topk_idx shape={dispatch_indices_arg.shape}")
